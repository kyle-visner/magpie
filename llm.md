...
contain other applications' namespaced events; Magpie adds its own bootstrap and ignores those
foreign events while preserving the shared root. A new Jaybase app does not need a Magpie change.
